...
def setup_django_sentry_logging(configuration):
    warnings.warn('deprecated functionality', DeprecationWarning)
    return configuration


def setup_service_sentry_logging(configuration, dsn):
    warnings.warn('deprecated functionality', DeprecationWarning)
    return configuration
